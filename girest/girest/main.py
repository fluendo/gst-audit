...
class GIRest:
            ...
            if tag == "interface":
                ...
                if interface and interface.get_type() == GIRepository.InfoType.CALLBACK:
                    ...
                    if self.sse_only:
                        ...
                        callback_param, callbacks_obj, is_sync = self._generate_callback_argument(
                            interface, arg, arg_name
                        )
    ...
    def _generate_callback(self, bi, schema_name=None, emitter_info=None):
        ...
        callback_schema = {"type": "object", "x-gi-type": "callback", "properties": request_properties}
