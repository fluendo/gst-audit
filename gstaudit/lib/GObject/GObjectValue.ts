...
export class GObjectValue {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GObjectValue> {
    const instance = new GObjectValue(ptr, transferType);
    if (transferType === 'full')
      gobjectvalueRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  async copy(dest_value: GObjectValue, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async init_from_instance(instance: GObjectTypeInstance, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async set_boolean(v_boolean: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_boxed(v_boxed?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_boxed_take_ownership(v_boxed?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_char(v_char: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_double(v_double: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_enum(v_enum: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_flags(v_flags: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_float(v_float: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_gtype(v_gtype: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_instance(instance?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_int(v_int: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_int64(v_int64: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_interned_string(v_string?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_long(v_long: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_object(v_object?: GObjectObject, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_param(param?: GObjectParamSpec, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_pointer(v_pointer?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_schar(v_char: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_static_boxed(v_boxed?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_static_string(v_string?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_string(v_string?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_string_take_ownership(v_string?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_uchar(v_uchar: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_uint(v_uint: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_uint64(v_uint64: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_ulong(v_ulong: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_variant(variant?: GLibVariant, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async take_boxed(v_boxed?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async take_string(v_string?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async take_variant(variant?: GLibVariant, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async unset(Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
