...
export class GObjectTypeClass {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GObjectTypeClass> {
    const instance = new GObjectTypeClass(ptr, transferType);
    if (transferType === 'full')
      gobjecttypeclassRegistry.register(instance, ptr);
    return instance;
  }
  ...
  async add_private(private_size: number, Prefer?: string): Promise<void> {
...
return Promise.reject("Call failed");
  ...
  static async adjust_private_offset(private_size_or_offset: number, g_class?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
