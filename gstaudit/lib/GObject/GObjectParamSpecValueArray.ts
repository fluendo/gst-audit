...
export class GObjectParamSpecValueArray extends GObjectParamSpec {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GObjectParamSpecValueArray> {
    const instance = new GObjectParamSpecValueArray(ptr, transferType);
