...
export class GObjectTypeInterface {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GObjectTypeInterface> {
    const instance = new GObjectTypeInterface(ptr, transferType);
    if (transferType === 'full')
      gobjecttypeinterfaceRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  static async add_prerequisite(interface_type: string, prerequisite_type: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  static async prerequisites(interface_type: string): Promise<Array<string>> {
    // Increment ref for parameters with full transfer ownership
