...
export type GstBasesink_query_pre_queue = (aggregator: GstBaseAggregator, aggregator_pad: GstBaseAggregatorPad, query: GstQuery) => void;

export async function convertGstBasesink_query_pre_queueArgs(data: any): Promise<Parameters<GstBasesink_query_pre_queue>> {
  return [
