...
export type GstBaseprepare_list = (sink: GstBaseBaseSink, buffer_list: GstBufferList) => void;

export async function convertGstBaseprepare_listArgs(data: any): Promise<Parameters<GstBaseprepare_list>> {
  return [
