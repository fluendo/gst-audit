...
export type GstVideoprepare_frame_start = (pad: GstVideoVideoAggregatorPad, videoaggregator: GstVideoVideoAggregator, buffer: GstBuffer, prepared_frame: GstVideoVideoFrame) => void;

export async function convertGstVideoprepare_frame_startArgs(data: any): Promise<Parameters<GstVideoprepare_frame_start>> {
  return [
