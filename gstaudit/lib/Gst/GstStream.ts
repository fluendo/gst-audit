...
export class GstStream extends GstObject {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstStream> {
    const instance = new GstStream(ptr, transferType);
...
return Promise.reject("Call failed");
  ...
  async set_stream_type(stream_type: GstStreamTypeValue, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
