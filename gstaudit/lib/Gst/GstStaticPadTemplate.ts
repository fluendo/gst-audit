...
import { GstStaticCaps } from './GstStaticCaps';
...
export class GstStaticPadTemplate {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstStaticPadTemplate> {
    const instance = new GstStaticPadTemplate(ptr, transferType);
    if (transferType === 'full')
      gststaticpadtemplateRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GstStaticPadTemplate.create(data.return.ptr, 'none');
  return instance;
}
...
const instance = await GstStaticCaps.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
