...
export class GstProtectionMeta {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstProtectionMeta> {
    const instance = new GstProtectionMeta(ptr, transferType);
    if (transferType === 'full')
      gstprotectionmetaRegistry.register(instance, ptr);
    return instance;
  }
