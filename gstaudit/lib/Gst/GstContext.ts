...
export class GstContext {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstContext> {
    const instance = new GstContext(ptr, transferType);
    if (transferType === 'full')
      gstcontextRegistry.register(instance, ptr);
    return instance;
  }
