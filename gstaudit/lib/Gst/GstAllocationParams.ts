...
export class GstAllocationParams {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstAllocationParams> {
    const instance = new GstAllocationParams(ptr, transferType);
    if (transferType === 'full')
      gstallocationparamsRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GstAllocationParams.create(data.return.ptr, 'full');
  return instance;
}
