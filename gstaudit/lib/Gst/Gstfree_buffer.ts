...
export type Gstfree_buffer = (pool: GstBufferPool, buffer: GstBuffer) => void;

export async function convertGstfree_bufferArgs(data: any): Promise<Parameters<Gstfree_buffer>> {
  return [
