...
export class GstParentBufferMeta {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstParentBufferMeta> {
    const instance = new GstParentBufferMeta(ptr, transferType);
    if (transferType === 'full')
      gstparentbuffermetaRegistry.register(instance, ptr);
    return instance;
  }
