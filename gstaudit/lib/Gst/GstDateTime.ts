...
export class GstDateTime {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstDateTime> {
    const instance = new GstDateTime(ptr, transferType);
    if (transferType === 'full')
      gstdatetimeRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GstDateTime.create(data.return.ptr, 'full');
  return instance;
}
