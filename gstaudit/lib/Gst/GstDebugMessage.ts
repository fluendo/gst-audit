...
export class GstDebugMessage {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstDebugMessage> {
    const instance = new GstDebugMessage(ptr, transferType);
    if (transferType === 'full')
      gstdebugmessageRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GstDebugMessage.create(data.return.ptr, 'none');
  return instance;
}
