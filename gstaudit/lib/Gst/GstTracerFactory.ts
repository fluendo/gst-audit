...
export class GstTracerFactory extends GstPluginFeature {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstTracerFactory> {
    const instance = new GstTracerFactory(ptr, transferType);
...
if (data.return && typeof data.return === 'object' && 'ptr' in data.return) {
  const instance = await GLibList.create(data.return.ptr, 'full', GstTracerFactory, undefined);
  return instance;
}
