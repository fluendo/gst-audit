...
export class GstReferenceTimestampMeta {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstReferenceTimestampMeta> {
    const instance = new GstReferenceTimestampMeta(ptr, transferType);
    if (transferType === 'full')
      gstreferencetimestampmetaRegistry.register(instance, ptr);
    return instance;
  }
