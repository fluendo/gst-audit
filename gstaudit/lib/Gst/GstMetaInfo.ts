...
import type { GstMetaClearFunction } from './GstMetaClearFunction';
import { convertGstMetaClearFunctionArgs } from './GstMetaClearFunction';
import type { GstMetaDeserializeFunction } from './GstMetaDeserializeFunction';
import { convertGstMetaDeserializeFunctionArgs } from './GstMetaDeserializeFunction';
import type { GstMetaFreeFunction } from './GstMetaFreeFunction';
import { convertGstMetaFreeFunctionArgs } from './GstMetaFreeFunction';
import type { GstMetaInitFunction } from './GstMetaInitFunction';
import { convertGstMetaInitFunctionArgs } from './GstMetaInitFunction';
import type { GstMetaSerializeFunction } from './GstMetaSerializeFunction';
import { convertGstMetaSerializeFunctionArgs } from './GstMetaSerializeFunction';
import type { GstMetaTransformFunction } from './GstMetaTransformFunction';
import { convertGstMetaTransformFunctionArgs } from './GstMetaTransformFunction';
...
export class GstMetaInfo {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstMetaInfo> {
    const instance = new GstMetaInfo(ptr, transferType);
    if (transferType === 'full')
      gstmetainfoRegistry.register(instance, ptr);
    return instance;
  }
