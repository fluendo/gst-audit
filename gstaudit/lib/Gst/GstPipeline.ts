...
export class GstPipeline extends GstBin {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstPipeline> {
    const instance = new GstPipeline(ptr, transferType);
...
const instance = await GstElement.create(data.return.ptr, 'none');
  ...
  async auto_clock(Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
const instance = await GstClock.create(data.return.ptr, 'full');
  ...
  async set_auto_flush_bus(auto_flush: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_delay(delay: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_latency(latency: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async use_clock(clock?: GstClock, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
