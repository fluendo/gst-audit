...
export class GstStaticCaps {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstStaticCaps> {
    const instance = new GstStaticCaps(ptr, transferType);
    if (transferType === 'full')
      gststaticcapsRegistry.register(instance, ptr);
    return instance;
  }
