...
export class GstCustomMeta {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstCustomMeta> {
    const instance = new GstCustomMeta(ptr, transferType);
    if (transferType === 'full')
      gstcustommetaRegistry.register(instance, ptr);
    return instance;
  }
