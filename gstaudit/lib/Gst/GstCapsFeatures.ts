...
export class GstCapsFeatures {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstCapsFeatures> {
    const instance = new GstCapsFeatures(ptr, transferType);
    if (transferType === 'full')
      gstcapsfeaturesRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  async add(feature: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async add_id(feature: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async remove(feature: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async remove_id(feature: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
