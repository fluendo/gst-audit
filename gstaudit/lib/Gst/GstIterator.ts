...
import type { GLibCompareFunc } from '../GLib/GLibCompareFunc';
import { convertGLibCompareFuncArgs } from '../GLib/GLibCompareFunc';
import { GObjectValue } from '../GObject/GObjectValue';
import type { GstIteratorCopyFunction } from './GstIteratorCopyFunction';
import { convertGstIteratorCopyFunctionArgs } from './GstIteratorCopyFunction';
import type { GstIteratorFoldFunction } from './GstIteratorFoldFunction';
import { convertGstIteratorFoldFunctionArgs } from './GstIteratorFoldFunction';
import type { GstIteratorForeachFunction } from './GstIteratorForeachFunction';
import { convertGstIteratorForeachFunctionArgs } from './GstIteratorForeachFunction';
import type { GstIteratorFreeFunction } from './GstIteratorFreeFunction';
import { convertGstIteratorFreeFunctionArgs } from './GstIteratorFreeFunction';
import type { GstIteratorItemFunction } from './GstIteratorItemFunction';
import { convertGstIteratorItemFunctionArgs } from './GstIteratorItemFunction';
import type { GstIteratorNextFunction } from './GstIteratorNextFunction';
import { convertGstIteratorNextFunctionArgs } from './GstIteratorNextFunction';
import { GstIteratorResult } from './GstIteratorResult';
import type { GstIteratorResultValue } from './GstIteratorResult';
import type { GstIteratorResyncFunction } from './GstIteratorResyncFunction';
import { convertGstIteratorResyncFunctionArgs } from './GstIteratorResyncFunction';



// Additional imports for AsyncIterable implementation
...
export class GstIterator implements AsyncIterable<GObjectObject | null> {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GstIterator> {
    const instance = new GstIterator(ptr, transferType);
    if (transferType === 'full')
      gstiteratorRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  async filter(user_data: GObjectValue, session_id: string, callback_secret: string, func: GLibCompareFunc): Promise<GstIterator> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async find_custom(elem: GObjectValue, session_id: string, callback_secret: string, func: GLibCompareFunc): Promise<boolean> {
    // Increment ref for parameters with full transfer ownership
  ...
  async fold(ret: GObjectValue, session_id: string, callback_secret: string, func: GstIteratorFoldFunction): Promise<GstIteratorResultValue> {
    // Increment ref for parameters with full transfer ownership
    ...
    if (typeof func !== 'undefined') {
      ...
      func_callbackInfo = callbackHandler.registerCallback(
        func, 
        convertGstIteratorFoldFunctionArgs,
        {
          methodName: 'fold',
          paramName: 'func'
        }
  ...
  async foreach(session_id: string, callback_secret: string, func: GstIteratorForeachFunction): Promise<GstIteratorResultValue> {
    // Increment ref for parameters with full transfer ownership
    ...
    if (typeof func !== 'undefined') {
      ...
      func_callbackInfo = callbackHandler.registerCallback(
        func, 
        convertGstIteratorForeachFunctionArgs,
        {
          methodName: 'foreach',
          paramName: 'func'
        }
  ...
  async push(other: GstIterator, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async resync(Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
const instance = await GstIterator.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
