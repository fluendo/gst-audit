...
import { GLibSourceCallbackFuncs } from './GLibSourceCallbackFuncs';
...
import { GLibSourcePrivate } from './GLibSourcePrivate';
...
export class GLibSource {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibSource> {
    const instance = new GLibSource(ptr, transferType);
    if (transferType === 'full')
      glibsourceRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  async add_child_source(child_source: GLibSource, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async add_poll(fd: GLibPollFD, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async get_current_time(timeval: GLibTimeVal, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async modify_unix_fd(tag: Pointer, new_events: GLibIOConditionValue, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async remove_child_source(child_source: GLibSource, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async remove_poll(fd: GLibPollFD, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async remove_unix_fd(tag: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_callback(session_id: string, callback_secret: string, func: GLibSourceFunc, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_callback_indirect(callback_funcs: GLibSourceCallbackFuncs, callback_data?: Pointer, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_can_recurse(can_recurse: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_funcs(funcs: GLibSourceFuncs, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_priority(priority: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_ready_time(ready_time: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_static_name(name: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  static async set_name_by_id(tag: number, name: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
...
const instance = await GLibSourceCallbackFuncs.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
...
const instance = await GLibSourcePrivate.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
