...
export class GLibThreadPool {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibThreadPool> {
    const instance = new GLibThreadPool(ptr, transferType);
    if (transferType === 'full')
      glibthreadpoolRegistry.register(instance, ptr);
    return instance;
  }
...
return Promise.reject("Call failed");
  ...
  async free(immediate: boolean, wait_: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  static async set_max_idle_time(interval: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  static async set_max_unused_threads(max_threads: number, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  static async stop_unused_threads(Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
