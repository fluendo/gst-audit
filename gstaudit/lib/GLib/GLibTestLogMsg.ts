...
export class GLibTestLogMsg {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibTestLogMsg> {
    const instance = new GLibTestLogMsg(ptr, transferType);
    if (transferType === 'full')
      glibtestlogmsgRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibTestLogMsg.create(data.return.ptr, 'none');
  return instance;
}
