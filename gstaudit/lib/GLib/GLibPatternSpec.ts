...
export class GLibPatternSpec {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibPatternSpec> {
    const instance = new GLibPatternSpec(ptr, transferType);
    if (transferType === 'full')
      glibpatternspecRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibPatternSpec.create(data.return.ptr, 'full');
  return instance;
}
