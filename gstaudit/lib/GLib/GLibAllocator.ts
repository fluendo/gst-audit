...
export class GLibAllocator {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibAllocator> {
    const instance = new GLibAllocator(ptr, transferType);
    if (transferType === 'full')
      gliballocatorRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibAllocator.create(data.return.ptr, 'none');
  return instance;
}
