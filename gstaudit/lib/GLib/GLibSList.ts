...
export class GLibSList {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibSList> {
    const instance = new GLibSList(ptr, transferType);
    if (transferType === 'full')
      glibslistRegistry.register(instance, ptr);
    return instance;
  }
