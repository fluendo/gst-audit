...
export class GLibMappedFile {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibMappedFile> {
    const instance = new GLibMappedFile(ptr, transferType);
    if (transferType === 'full')
      glibmappedfileRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibMappedFile.create(data.return.ptr, 'full');
  return instance;
}
