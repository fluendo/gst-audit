...
export class GLibTestCase {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibTestCase> {
    const instance = new GLibTestCase(ptr, transferType);
    if (transferType === 'full')
      glibtestcaseRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibTestCase.create(data.return.ptr, 'none');
  return instance;
}
