...
export class GLibTreeNode {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibTreeNode> {
    const instance = new GLibTreeNode(ptr, transferType);
    if (transferType === 'full')
      glibtreenodeRegistry.register(instance, ptr);
    return instance;
  }
