...
export class GLibString {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibString> {
    const instance = new GLibString(ptr, transferType);
    if (transferType === 'full')
      glibstringRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibString.create(data.return.ptr, 'full');
  return instance;
}
