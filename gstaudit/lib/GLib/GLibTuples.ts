...
export class GLibTuples {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibTuples> {
    const instance = new GLibTuples(ptr, transferType);
    if (transferType === 'full')
      glibtuplesRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibTuples.create(data.return.ptr, 'none');
  return instance;
}
