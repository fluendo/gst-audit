...
export class GLibOptionGroup {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibOptionGroup> {
    const instance = new GLibOptionGroup(ptr, transferType);
    if (transferType === 'full')
      gliboptiongroupRegistry.register(instance, ptr);
    return instance;
  }
  ...
  static async new(name: string, description: string, help_description: string, session_id: string, callback_secret: string, destroy: GLibDestroyNotify, user_data?: Pointer): Promise<GLibOptionGroup> {
...
const instance = await GLibOptionGroup.create(data.return.ptr, 'full');
  return instance;
}
return Promise.reject("Call failed");
  ...
  async add_entries(entries: Array<GLibOptionEntry>, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
