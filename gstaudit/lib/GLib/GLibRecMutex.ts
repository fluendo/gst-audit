...
export class GLibRecMutex {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibRecMutex> {
    const instance = new GLibRecMutex(ptr, transferType);
    if (transferType === 'full')
      glibrecmutexRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibRecMutex.create(data.return.ptr, 'none');
  return instance;
}
