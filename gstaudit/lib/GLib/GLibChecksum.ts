...
export class GLibChecksum {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibChecksum> {
    const instance = new GLibChecksum(ptr, transferType);
    if (transferType === 'full')
      glibchecksumRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibChecksum.create(data.return.ptr, 'full');
  return instance;
}
