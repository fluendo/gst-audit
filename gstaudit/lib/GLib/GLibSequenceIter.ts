...
import { GLibSequence } from './GLibSequence';
...
export class GLibSequenceIter {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibSequenceIter> {
    const instance = new GLibSequenceIter(ptr, transferType);
    if (transferType === 'full')
      glibsequenceiterRegistry.register(instance, ptr);
    return instance;
  }
