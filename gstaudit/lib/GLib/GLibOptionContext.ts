...
import { GLibOptionGroup } from './GLibOptionGroup';
import type { GLibTranslateFunc } from './GLibTranslateFunc';
import { convertGLibTranslateFuncArgs } from './GLibTranslateFunc';
...
export class GLibOptionContext {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibOptionContext> {
    const instance = new GLibOptionContext(ptr, transferType);
    if (transferType === 'full')
      gliboptioncontextRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibOptionContext.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
  ...
  async add_group(group: GLibOptionGroup, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async add_main_entries(entries: Array<GLibOptionEntry>, translation_domain?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async get_main_group(): Promise<GLibOptionGroup> {
    ...
    // Return value is a struct, instantiate it from the ptr
if (data.return && typeof data.return === 'object' && 'ptr' in data.return) {
const instance = await GLibOptionGroup.create(data.return.ptr, 'none');
  return instance;
}
return Promise.reject("Call failed");
  ...
  async parse(argv: Array<string>): Promise<{argv: Array<string>, return: boolean}> {
    // Increment ref for parameters with full transfer ownership
  ...
  async parse_strv(arguments_: Array<string>): Promise<{arguments: Array<string>, return: boolean}> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_description(description?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_help_enabled(help_enabled: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_ignore_unknown_options(ignore_unknown: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_main_group(group: GLibOptionGroup, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_strict_posix(strict_posix: boolean, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_summary(summary?: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async set_translate_func(session_id: string, callback_secret: string, func: GLibTranslateFunc, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
    ...
    if (typeof func !== 'undefined') {
      ...
      func_callbackInfo = callbackHandler.registerCallback(
        func, 
        convertGLibTranslateFuncArgs,
        {
          methodName: 'set_translate_func',
          paramName: 'func'
        }
      );
  ...
  async set_translation_domain(domain: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
