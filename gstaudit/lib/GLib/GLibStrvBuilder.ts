...
export class GLibStrvBuilder {
  ...
  static async create(ptr: string, transferType: transferType): Promise<GLibStrvBuilder> {
    const instance = new GLibStrvBuilder(ptr, transferType);
    if (transferType === 'full')
      glibstrvbuilderRegistry.register(instance, ptr);
    return instance;
  }
...
const instance = await GLibStrvBuilder.create(data.return.ptr, 'full');
  return instance;
}
return Promise.reject("Call failed");
  ...
  async add(value_: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async addv(value_: Array<string>, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
  ...
  async end(): Promise<Array<string>> {
    // Increment ref for parameters with full transfer ownership
...
return Promise.reject("Call failed");
  ...
  async take(value_: string, Prefer?: string): Promise<void> {
    // Increment ref for parameters with full transfer ownership
